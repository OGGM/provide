...
grid_plots_outpath = os.path.join(base_dir, 'basins', resolution_dir, 'grid_plots')
utils.mkdir(grid_plots_outpath);

aggregated_data_outpath = os.path.join(base_dir, 'basins', resolution_dir, 'aggregated_data')
...
if is_notebook:
    test_region_index = gdf_regions[gdf_regions[name_col_regions] == 'rhone'].index[0]
