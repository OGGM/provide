...
preprocess_country_dict_outpath = os.path.join(base_dir, 'countries', 'resolution_1_deg')
utils.mkdir(preprocess_country_dict_outpath);

grid_plots_outpath = os.path.join(base_dir, 'countries', 'resolution_1_deg', 'grid_plots')
utils.mkdir(grid_plots_outpath);

aggregated_data_outpath = os.path.join(base_dir, 'countries', 'resolution_1_deg', 'aggregated_data')
