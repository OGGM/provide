#!/bin/bash
#
# SBATCH --job-name=provide_common_running_glaciers
# SBATCH --ntasks=1
...
PROVIDE_REG=`printf "P%02d" $SLURM_ARRAY_TASK_ID`
export PROVIDE_REG
echo "RGI Region: $PROVIDE_REG"
...
singularity exec /home/users/pschmitt/docker_image/oggm_20240202.sif bash -s <<EOF
  ...
  python -u Get_common_running_glaciers.py
EOF
