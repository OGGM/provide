#!/bin/bash
#
#SBATCH --job-name=provide_aggregation_regions_scenario
#SBATCH --ntasks=1
...
singularity exec /home/users/pschmitt/docker_image/oggm_20240202.sif bash -s <<EOF
  ...
  python -u aggregation_workflow_scenario.py
EOF

# Write out files
echo "Copying files..."
rsync -avzh "$OGGM_WORKDIR/aggregated_data/" ./aggregated_data/
#rsync -avzh "$OGGM_WORKDIR/aggregated_data_intermediate/" ./aggregated_data_intermediate/
