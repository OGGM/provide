...
grid_plots_outpath = os.path.join(base_dir, 'global', resolution_dir, 'grid_plots')
utils.mkdir(grid_plots_outpath);

aggregated_data_outpath = os.path.join(base_dir, 'global', resolution_dir, 'aggregated_data')
